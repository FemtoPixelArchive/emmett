 ...
 * @subpackage Core
 */
class External_PhpThumb_GdThumb extends External_PhpThumb_ThumbBase
{
	/**
	...
	protected function verifyFormatCompatiblity ()
	{
		...
		switch ($this->format)
		{
			case 'GIF':
				...
				break;
			case 'JPG':
				$isCompatible = isset($gdInfo['JPG Support']) ? $gdInfo['JPG Support'] : (isset($gdInfo['JPEG Support']) ? $gdInfo['JPEG Support'] : false);
				break;
			case 'PNG':
