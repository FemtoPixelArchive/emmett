 ...
 * @subpackage Plugins
 */
class External_PhpThumb_Plugins_GdReflectionLib
{
	/**
...
$pt = External_PhpThumb_PhpThumb::getInstance();
$pt->registerPlugin('External_PhpThumb_Plugins_GdReflectionLib', 'gd');